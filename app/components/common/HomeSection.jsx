...
function HomeSection() {
  return (
    <Section className='home w-full h-[700px] xl:h-[89vh] flex flex-col justify-center items-center text-center gap-5 xl:px-[190px] bg-cover 2xl:bg-size-[100%] xl:gap-10 text-white' id='home'>

...
function CategoriesSection() {
  return (
    <Section className='py-10 flex flex-col items-center justify-start gap-5'>
      <div className='md:flex md:justify-between md:items-center md:w-full md:gap-10'>
        ...
        <p className='text-secondary'>Qisqacha ko‘rib chiqishingiz kerak bo‘lgan kategoriyalarni siz bilan baham ko‘rmoqchiman. Ko‘rib tanishib chiqing.</p>
      </div>
